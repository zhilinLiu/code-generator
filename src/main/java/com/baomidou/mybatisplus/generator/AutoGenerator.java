...
public class AutoGenerator {
    ...
    public void execute() {
        ...
        if(templateEngine instanceof ZipTemplateEngine){
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
            //初始化输出流
            ZipOutputStream zot = new ZipOutputStream(byteArrayOutputStream);
            ZipTemplateEngine zipTemplateEngine = new ZipTemplateEngine(zot);

            templateEngine = zipTemplateEngine;
